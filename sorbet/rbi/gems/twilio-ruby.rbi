...
class Twilio::REST::Api::V2010::AccountContext::MessageList < Twilio::REST::ListResource
  def create(to: nil, status_callback: nil, application_sid: nil, max_price: nil, provide_feedback: nil, validity_period: nil, force_delivery: nil, smart_encoded: nil, persistent_action: nil, from: nil, messaging_service_sid: nil, body: nil, media_url: nil); end
  def each; end
  def get_page(target_url); end
  def initialize(version, account_sid: nil); end
...
class Twilio::REST::Preview::TrustedComms::BusinessContext::InsightsList::SuccessRateList < Twilio::REST::ListResource
  def initialize(version, business_sid: nil); end
  def to_s; end
end
class Twilio::REST::Preview::TrustedComms::BusinessContext::InsightsList::SuccessRatePage < Twilio::REST::Page
  def get_instance(payload); end
  def initialize(version, response, solution); end
  def to_s; end
end
class Twilio::REST::Preview::TrustedComms::BusinessContext::InsightsList::SuccessRateContext < Twilio::REST::InstanceContext
...
class Twilio::REST::Preview::TrustedComms::BusinessContext::InsightsList::SuccessRateInstance < Twilio::REST::InstanceResource
  def account_sid; end
  def business_sid; end
  def context; end
  def end_; end
...
class Twilio::REST::Verify::V2::ServiceContext::VerificationList < Twilio::REST::ListResource
  def create(to: nil, channel: nil, custom_message: nil, send_digits: nil, locale: nil, custom_code: nil, amount: nil, payee: nil, rate_limits: nil, channel_configuration: nil); end
  def initialize(version, service_sid: nil); end
  def to_s; end
end
